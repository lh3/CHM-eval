...
was applied.  (a) comparison of CHM-pair, GIAB and PlatGen benchmark data sets
...
of the mapping algorithms. GATK best practice pipeline runs BWA-MEM and
post-processes alignments with base quality recalibration and INDEL
realignment. INDEL accuracy on SNAP alignment is only shown for GATK-HC because
