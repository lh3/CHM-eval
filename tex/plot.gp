...
plot \
	"<awk '$NF==\"flt\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 2:xtic(8) not ls 1, \
	"<awk '/flt/&&/giab/' NA12878.txt | grep -v +asm | sort -k8,8" u 2:xtic(8) not ls 3, \
	"<awk '/flt/&&/pg/' NA12878.txt | grep -v +asm | sort -k8,8" u 2:xtic(8) not ls 2
unset label
...
set bmargin
plot \
	"<awk '$NF==\"flt\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 1:xtic(8) not ls 1, \
	"<awk '/flt/&&/giab/' NA12878.txt | grep -v +asm | sort -k8,8" u 1:xtic(8) not ls 3, \
	"<awk '/flt/&&/pg/' NA12878.txt | grep -v +asm | sort -k8,8" u 1:xtic(8) not ls 2
...
set bmargin
plot \
	"<awk '$NF==\"flt\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 3:xtic(8) not ls 1, \
	"<awk '/flt/&&/giab/' NA12878.txt | grep -v +asm | sort -k8,8" u 3:xtic(8) not ls 3, \
	"<awk '/flt/&&/pg/' NA12878.txt | grep -v +asm | sort -k8,8" u 3:xtic(8) not ls 2
...
set label "(mapped to GRCh37+decoy with BWA-MEM)" at graph .03,.9 font "Helvetica,24"
plot \
	"<awk '$NF==\"raw\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 2:xtic(8) not ls 1, \
	"<awk '$NF==\"flt\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 2:xtic(8) not ls 3
unset label
...
set yran [0:6.2]; set ytics 2
set ylab "INDEL FPPM" off -.5
set key bot left at -1.9,4.35
unset xtics
plot \
	"<awk '$NF==\"raw\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 4:xtic(8) t 'Unfiltered calls' ls 1, \
	"<awk '$NF==\"flt\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 4:xtic(8) t 'Filtered calls' ls 3
...
set bmargin
plot \
	"<awk '$NF==\"raw\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 1:xtic(8) not ls 1, \
	"<awk '$NF==\"flt\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 1:xtic(8) not ls 3
...
set bmargin
plot \
	"<awk '$NF==\"raw\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 3:xtic(8) not ls 1, \
	"<awk '$NF==\"flt\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 3:xtic(8) not ls 3
...
plot \
	"<awk '$NF==\"flt\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 2:xtic(8) not ls 1, \
	"<awk '$NF==\"flt-c\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 2:xtic(8) not ls 3, \
	"<awk '$NF==\"flt-u\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 2:xtic(8) not ls 2, \
	"<cat hs37d5-func.txt | grep -v +asm | sort -k8,8" u 2:xtic(8) not ls 4
unset label
...
plot \
	"<awk '$NF==\"flt\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 1:xtic(8) not ls 1, \
	"<awk '$NF==\"flt-c\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 1:xtic(8) not ls 3, \
	"<awk '$NF==\"flt-u\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 1:xtic(8) not ls 2, \
	"<cat hs37d5-func.txt | grep -v +asm | sort -k8,8" u 1:xtic(8) not ls 4
...
plot \
	"<awk '$NF==\"flt\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 3:xtic(8) not ls 1, \
	"<awk '$NF==\"flt-c\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 3:xtic(8) not ls 3, \
	"<awk '$NF==\"flt-u\"' hs37d5-all.txt | grep -v +asm | sort -k8,8"  u 3:xtic(8) not ls 2, \
	"<cat hs37d5-func.txt | grep -v +asm | sort -k8,8" u 3:xtic(8) not ls 4
...
plot \
	...
	"<awk '/bwamem/' hs38-func.txt | grep -v +asm | sort -k8,8"  u 2:xtic(8) not ls 3, \
	"<awk '/bwamem/' hs37d5-func.txt | grep -v +asm | sort -k8,8"  u 2:xtic(8) not ls 2
unset label
...
unset xtics
plot \
	"<awk '/msb2/&&((/broad/&&!/FermiKit/)||(/bwamem/&&/FermiKit/))' hs37m-func.txt | grep -v +asm | sort -k8,8"  u 4:xtic(8) t 'GRCh37' ls 1, \
	"<awk '/bwamem/' hs38-func.txt | grep -v +asm | sort -k8,8"  u 4:xtic(8) t 'GRCh38' ls 3, \
	"<awk '/bwamem/' hs37d5-func.txt | grep -v +asm | sort -k8,8"  u 4:xtic(8) t 'GRCh37+decoy' ls 2
...
plot \
	...
	"<awk '/bwamem/' hs38-func.txt | grep -v +asm | sort -k8,8"  u 1:xtic(8) not ls 3, \
	"<awk '/bwamem/' hs37d5-func.txt | grep -v +asm | sort -k8,8"  u 1:xtic(8) not ls 2
...
plot \
	...
	"<awk '/bwamem/' hs38-func.txt | grep -v +asm | sort -k8,8"  u 3:xtic(8) not ls 3, \
	"<awk '/bwamem/' hs37d5-func.txt | grep -v +asm | sort -k8,8"  u 3:xtic(8) not ls 2
